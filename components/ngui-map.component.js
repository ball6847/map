import { Component, ElementRef, ViewEncapsulation, EventEmitter, Output, Inject, NgZone } from '@angular/core';
...
var NguiMapComponent = /** @class */ (function () {
    function NguiMapComponent(optionBuilder, elementRef, geolocation, geoCoder, nguiMap, apiLoader, zone, config) {
        var _this = this;
    ...
    NguiMapComponent.prototype.initializeMap = function () {
        ...
        this.zone.runOutsideAngular(function () {
            ...
            debounceTime.call(_this.inputChanges$, typeof _this.config.inputDebounceTime === 'number' ? _this.config.inputDebounceTime : 1000)
    ...
    NguiMapComponent.ctorParameters = function () { return [
        ...
        { type: NgMapApiLoader, },
        { type: NgZone, },
        { type: undefined, decorators: [{ type: Inject, args: [NG_MAP_CONFIG_TOKEN,] },] },
    ]; };
