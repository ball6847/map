...
import { ConfigOption } from '../services/config';
export declare class NguiMapComponent implements OnChanges, OnDestroy, AfterViewInit, AfterViewChecked {
    ...
    constructor(optionBuilder: OptionBuilder, elementRef: ElementRef, geolocation: NavigatorGeolocation, geoCoder: GeoCoder, nguiMap: NguiMap, apiLoader: NgMapApiLoader, zone: NgZone, config: ConfigOption);
